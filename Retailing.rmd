...
Customer_Final_dplyr <- full_join(Trans_Cust,Prod_Cat_Info_1,by="prod_subcat_code")

```


```{r}
# Qns 2 Prepare a Summary Report for Merged Data Set. Generate histograms for all continuous variables, and frequency variables for categorical variables
